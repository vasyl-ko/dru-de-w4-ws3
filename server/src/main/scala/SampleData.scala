...
object SampleData {
  val movies = Set(
    ...
    Movie(903,
          ...
          216,
          "English",
          Option(LocalDate.parse("1962-12-11")),
          "UK"),
    Movie(904,
          "The Deer Hunter",
          1978,
          183,
          "English",
          Option(LocalDate.parse("1979-03-08")),
          "UK"),
    Movie(905,
          "Amadeus",
          1984,
          160,
          "English",
          Option(LocalDate.parse("1985-01-07")),
          "UK"),
    Movie(906,
          "Blade Runner",
          1982,
          117,
          "English",
          Option(LocalDate.parse("1982-09-09")),
          "UK"),
    ...
    Movie(908,
          ...
          106,
          "English",
          Option(LocalDate.parse("1995-08-25")),
          "UK"),
    Movie(909,
          "Chinatown",
          1974,
          130,
          "English",
          Option(LocalDate.parse("1974-08-09")),
          "UK"),
    Movie(910,
          "Boogie Nights",
          1997,
          155,
          "English",
          Option(LocalDate.parse("1998-02-16")),
          "UK"),
    Movie(911,
          "Annie Hall",
          1977,
    ...
    Movie(912,
          ...
          134,
          "Japanese ",
          Option(LocalDate.parse("2001-10-19")),
          "UK"),
    Movie(913,
          ...
          142,
          "English",
          Option(LocalDate.parse("1995-02-17")),
          "UK"),
    ...
    Movie(915,
          ...
          194,
          "English",
          Option(LocalDate.parse("1998-01-23")),
          "UK"),
    Movie(916,
          "Good Will Hunting",
          1997,
          126,
          "English",
          Option(LocalDate.parse("1998-06-03")),
          "UK"),
    Movie(917,
          "Deliverance",
          1972,
          109,
          "English",
          Option(LocalDate.parse("1982-10-05")),
          "UK"),
    Movie(918,
          "Trainspotting",
          1996,
          94,
          "English",
          Option(LocalDate.parse("1996-02-23")),
          "UK"),
    Movie(919,
          "The Prestige",
          2006,
          130,
          "English",
          Option(LocalDate.parse("2006-11-10")),
          "UK"),
    ...
    Movie(921,
          ...
          120,
          "English",
          Option(LocalDate.parse("2009-01-09")),
          "UK"),
    Movie(922,
          "Aliens",
          1986,
          137,
          "English",
          Option(LocalDate.parse("1986-08-29")),
          "UK"),
    Movie(923,
          "Beyond the Sea",
          2004,
          118,
          "English",
          Option(LocalDate.parse("2004-11-26")),
          "UK"),
    Movie(924,
          "Avatar",
          2009,
          162,
          "English",
          Option(LocalDate.parse("2009-12-17")),
          "UK"),
    Movie(926,
          "Seven Samurai",
          1954,
    ...
    Movie(927,
          ...
          125,
          "Japanese ",
          Option(LocalDate.parse("2003-09-12")),
          "UK"),
    Movie(928,
          "Back to the Future",
          1985,
          116,
          "English",
          Option(LocalDate.parse("1985-12-04")),
          "UK"),
    Movie(925,
          "Braveheart",
          1995,
          178,
          "English",
          Option(LocalDate.parse("1995-09-08")),
          "UK")
  )
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      Await.result(movieRepository.createSchema(), 5.seconds)
      println("Created schema")
      Await.result(
        for {
          _ <- db.run { MovieTable.query ++= movies }
          _ <- db.run { ActorTable.query ++= actors }
          _ <- db.run { GenreTable.query ++= genres }
          _ <- db.run { DirectorTable.query ++= directors }
          _ <- db.run { ReviewerTable.query ++= reviewers }
          _ <- db.run { RatingTable.query ++= ratings }
          _ <- db.run { MovieCastTable.query ++= movieCasts }
          _ <- db.run { MovieDirectionTable.query ++= movieDirections }
          _ <- db.run { MovieGenreTable.query ++= movieGenres }
        } yield (),
        10.seconds
      )
